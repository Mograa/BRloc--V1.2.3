...
def menu():
    ...
    {color_yellow}[4] {color_green}FakeAddr      {color_yellow}[8] {color_green}Portscan         
    
    
    {color_yellow}V{color_green}1{color_white}.{color_yellow}2{color_white}.{color_green}3{color_white}| {color_yellow}[{color_green}0{color_yellow}]{color_green}Exit
"""
    print(main_menu)
