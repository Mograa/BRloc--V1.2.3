...
def installer_menu():
    ...
    {color_yellow}V{color_green}1{color_white}.{color_yellow}2{color_white}.{color_green}3 {color_white}| {color_yellow}[{color_green}0{color_yellow}]{color_green}Return
    """
